    ...
    <div class="flex justify-center">
        <div class="w-auto sm:w-72 md:w-80 bg-white p-5 rounded-2xl text-black shadow-lg">
            <form action="{{ route('change_password') }}" method="post">
                ...
                <div>
                    <button type="submit" class="hover:opacity-80 duration-300 text-white px-4 py-3 rounded-xl font-medium w-full" style="background-color: orange">Change Password</button>
                </div>
            </form>
        </div>
    </div>
