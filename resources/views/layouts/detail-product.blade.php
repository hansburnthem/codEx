        ...
        <div class="d-flex bd-highlight mb-4" style="">
            <div class="d-flex flex-row ml-3" style="margin:30px;">
                <div class="p-2 bd-highlight">
                    <!--Get book Images-->
                    <img class="card-img-top" src="{{ asset($detail->book_img) }}" style="width:390px; height:500px; margin:5px;">
                </div>
                <div class="ml-auto p-2 bd-highlight">
                    <div class="d-flex flex-row">
                        <div class="d-flex flex-row" style="">
                            <div class="col">
                                <!--Get book Name-->
                                <h1>{{ $detail-> book_name }}</h1>
                                <!--Get book Price-->
                                <h5>Rp {{ $detail-> book_price }}</h5><br> <br>
                                <!--Get book Description-->
                                <h5>Description:</h5> {{ $detail -> book_desc }} <br> <br> <br>
                            </div>
                        </div>
                    </div>
                </div>
